...
and provides means for quantification over data, something which LTL is missing. For example, with our approach, a practicioner can use 
...
% for monitor, give the example of the LTL3 tools, where ``actions'' are labeled on the transitions of the Buchi automaton,
% but thes are not really actions but atomic propositions, since it's not logical to have actionA && actionB in a transition
