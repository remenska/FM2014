...
To mitigate the problem, several approaches propose conversational tools for
...
Another category of approaches deal with temporal extensions 
...
of a model. Finally, a third class of approaches tackle the property
...
\begin{figure*}[t!]
  \centering
  \subfloat{\label{fig:Prospec}\includegraphics[width=0.7\linewidth]{./Prospec.png}}    
  \hfill
