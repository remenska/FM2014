...
of a system in a recursive-like manner.
...
\emph{[!exists n:Nat.read(n+n)]false} states that a process should not execute read actions with odd-valued natural numbers.
