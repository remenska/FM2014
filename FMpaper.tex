...
\fbox{\includegraphics[width=1.0\linewidth,keepaspectratio=true]{./MonitorConstruction.png}}%
}%
\caption{Transforming a $\mu$-calculus formula into a monitor}
\label{fig:MonitorConstruction}
\vspace{-6 pt}
\end{figure}
Intuitively, monitor process will step through those exact actions that the original system takes. If a sequence of steps refuting the formula is completed,
