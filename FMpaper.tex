...
- mention why they are not used in practice; semantics not clear; 
- UML spec valid vs invalid traces; open vs closed world;

- alternative semantics proposed to clarify;

- they should be considered rather as modalities;
- we restrict their usage to simple non-nested fragments with one message
  and we use them as modalities to specify properties;
...
trace is a sequence of event occurrences~\cite{UML2.4_superstructure}. 
While the addition
