...
and a UML sequence diagram depicting the desired behavior. Most approaches to date 
have focused on LTL, which is a state-based temporal logic formalism. On the other hand,
...
In both approaches, Buchi automata and LTL formulas are generated automatically from the diagrams.
...
Observers, or monitors (\`{a} la Buchi) defined in the mCRL2 model itself, can sometimes
...
Figure~\ref{fig:ResponsePattern} depicts the \emph{precedence chain} pattern (with
...
\begin{figure*}[t!]
  \centering
  \subfloat[Sequence Diagram with monitor]{\label{fig:ResponsePattern}\includegraphics[width=0.62\linewidth]{./ResponseChain_withMonitor.png}}    
  \hfill
  \subfloat[PSC with Buchi automaton]{\label{fig:ResponsePatternCharmy}\includegraphics[width =0.38\linewidth]{./ResponseChainPSC.png}}
...
% \begin{figure*}[t!]
%   \centering
%   \subfloat[A Buchi automaton~\cite{Bauer:2011:RVL:2000799.2000800}]{\label{fig:ResponsePattern}\includegraphics[width=0.4\linewidth]{./Buchi.png}}    
%   \label{fig:Buchi}
%   \hfill
%   \subfloat[PSC with Buchi automaton]{\label{fig:PASSlaunch}\includegraphics[width =0.38\linewidth]{./PASSlaunch.png}}
%   \caption{}
% \end{figure*}
...
On the other hand, by defining an end-scope of a property, we can also assert
...
\fbox{\includegraphics[width=1.05\linewidth,keepaspectratio=true]{./ScopeSelection1.png}}%
}%
...
For example, the definition of the \emph{Before-R} scope requires that the \emph{R}
...
in which the behavior is analyzed, are reflected in the questionnaire.

Due to space restriction we do not show the Behavior Question Tree part of the wizard, although it is easy to
...
The actual events of interest in this case are \emph{pushTask} and \emph{popTask}.
...
\setlength{\fboxsep}{1.5pt}%
\setlength{\fboxrule}{0.5pt}%
\fbox{\includegraphics[width=1.05\linewidth,keepaspectratio=true]{./Last.png}}%
}%
\caption{Damn it}
\label{fig:Last}
\end{figure}
...
% \setlength{\fboxsep}{1.5pt}%
% \setlength{\fboxrule}{0.5pt}%
% \fbox{\includegraphics[width=1.05\linewidth,keepaspectratio=true]{./PasspopupWin.png}}%
% }%
% \caption{Damn it}
% \label{fig:Last}
% \end{figure}
