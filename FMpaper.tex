...
A general model checking mechanism used with state-based formalism tools like SPIN 
...
generated in the process. Runtime or on-the-fly verification
...
propositions rather than single actions (notice the $\wedge$ operator). 
...
monitorable properties is strictly larger than the commonly used class of \emph{safety} properties.
...
with or without a scope combination.
...
Using the above translation, such a monitor can be placed in parallel a the system model,
