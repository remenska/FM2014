...
% showcase:
%	data quantification
% 	universality pattern, how it's adapted
% 	popup window for selection of a message
% 	extended patterns in the questionnaire (example ...total of xx new distinct variations of this property pattern)
...
Here we illustrate how PASS can be used in practice. 
